...
export const CharacterSchema = new Schema(
  {
    ...
    pace: { type: String, required: true, maxLength: 20 },
    parry: { type: String, required: true, maxLength: 20 },
    toughness: { type: String, required: true, maxLength: 20 },
    ...
    agilityBonus: { type: Number },
    smartsBonus: { type: Number },
    spiritBonus: { type: Number },
    strengthBonus: { type: Number },
    vigorBonus: { type: Number },
    fatigue: { type: Number },
    wounds: { type: Number },
